...
public class CDSHighlighter extends SyntaxHighlighterBase {
    ...
    private static final TextAttributesKey KEY = createTextAttributesKey("CDSKey", DefaultLanguageHighlighterColors.KEYWORD);
    ...
    private static final TextAttributesKey METHOD = createTextAttributesKey("CDSMethod", DefaultLanguageHighlighterColors.FUNCTION_DECLARATION);
    ...
    public static class CDSSyntaxHighlighterFactory extends SyntaxHighlighterFactory {
        ...
        public @NotNull SyntaxHighlighter getSyntaxHighlighter(@Nullable Project project, @Nullable VirtualFile virtualFile) {
            return new de.joachimsohn.cds.CDSHighlighter();
        }
    }
}
