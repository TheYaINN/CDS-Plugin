...
public class CDSExprImpl extends ASTWrapperPsiElement implements CDSExpr {

  public CDSExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public CDSValue_ getValue_() {
    return findChildByClass(CDSValue_.class);
  }

  @Override
  @Nullable
  public CDSVariable getVariable() {
    return findChildByClass(CDSVariable.class);
  }
