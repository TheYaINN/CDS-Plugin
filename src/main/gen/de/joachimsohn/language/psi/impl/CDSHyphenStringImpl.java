...
public class CDSHyphenStringImpl extends ASTWrapperPsiElement implements CDSHyphenString {

  public CDSHyphenStringImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CDSVisitor visitor) {
    visitor.visitHyphenString(this);
  }
