...
public class CDSImportValuesImpl extends ASTWrapperPsiElement implements CDSImportValues {

  public CDSImportValuesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CDSVisitor visitor) {
    visitor.visitImportValues(this);
  }
