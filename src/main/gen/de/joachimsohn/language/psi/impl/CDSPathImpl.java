...
public class CDSPathImpl extends ASTWrapperPsiElement implements CDSPath {

  public CDSPathImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CDSStringConcat> getStringConcatList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CDSStringConcat.class);
  }
