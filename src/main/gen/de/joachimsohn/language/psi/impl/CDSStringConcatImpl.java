...
public class CDSStringConcatImpl extends ASTWrapperPsiElement implements CDSStringConcat {

  public CDSStringConcatImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CDSVisitor visitor) {
    visitor.visitStringConcat(this);
  }
