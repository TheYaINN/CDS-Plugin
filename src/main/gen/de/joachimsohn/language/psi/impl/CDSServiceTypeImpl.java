...
public class CDSServiceTypeImpl extends ASTWrapperPsiElement implements CDSServiceType {

  public CDSServiceTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CDSDataType> getDataTypeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CDSDataType.class);
  }
