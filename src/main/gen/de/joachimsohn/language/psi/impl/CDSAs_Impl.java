...
public class CDSAs_Impl extends ASTWrapperPsiElement implements CDSAs_ {

  public CDSAs_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CDSVisitor visitor) {
    visitor.visitAs_(this);
  }
  ...
  @Override
  @NotNull
  public CDSAsRecursive getAsRecursive() {
    return findNotNullChildByClass(CDSAsRecursive.class);
  }
