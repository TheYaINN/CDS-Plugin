...
public class CDSRequired_Impl extends ASTWrapperPsiElement implements CDSRequired_ {

  public CDSRequired_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CDSVisitor visitor) {
    visitor.visitRequired_(this);
  }
