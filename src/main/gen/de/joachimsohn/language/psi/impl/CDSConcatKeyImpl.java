...
public class CDSConcatKeyImpl extends ASTWrapperPsiElement implements CDSConcatKey {

  public CDSConcatKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CDSVisitor visitor) {
    visitor.visitConcatKey(this);
  }
