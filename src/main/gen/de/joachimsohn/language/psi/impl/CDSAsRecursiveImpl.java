...
public class CDSAsRecursiveImpl extends ASTWrapperPsiElement implements CDSAsRecursive {

  public CDSAsRecursiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CDSVisitor visitor) {
    visitor.visitAsRecursive(this);
  }
  ...
  @Override
  @NotNull
  public List<CDSAsRecursive> getAsRecursiveList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CDSAsRecursive.class);
  }
