...
public class CDSAnnotationToImpl extends ASTWrapperPsiElement implements CDSAnnotationTo {

  public CDSAnnotationToImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CDSVisitor visitor) {
    visitor.visitAnnotationTo(this);
  }
